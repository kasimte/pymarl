# From: https://github.com/chaovven/SMIX
import copy
...
class SLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        target_chosen_action_qvals = th.gather(target_mac_out, 3, batch['actions']).squeeze(-1)  # [32, 52, 3]

        if self.mixer is None:
            target_qvals = target_chosen_action_qvals
        else:
            target_qvals = self.target_mixer(target_chosen_action_qvals, batch['state'])  # [32, 52, 1]
